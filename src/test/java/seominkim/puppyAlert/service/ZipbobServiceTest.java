...
public class ZipbobServiceTest {
    ...
    public void findOneTest(){
        ...
        // when
        ZipbobDTO zipbobDTO = new ZipbobDTO();
        zipbobDTO.setHostId(host.getHostId());
        zipbobDTO.setPuppyId(puppy.getPuppyId());
        zipbobDTO.setMenu("제육덮밥");
        zipbobDTO.setTime(LocalDateTime.now());
        zipbobDTO.setStatus(ZipbobStatus.MATCHED);

        Long savedId = zipbobService.add(zipbobDTO);
